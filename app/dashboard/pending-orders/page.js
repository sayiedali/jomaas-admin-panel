...
const page = () => {
  ...
  useEffect(() => {
    axios
      .get("https://jomaasbackendai.onrender.com/api/v1/order/allnoworder")
      .then((res) => {
  ...
  // console.log("Output => my order", orderDetailObj);
  ...
  return (
    <div className="pt-[80px] p-[10px] w-full">
      ...
      {/* <button className="ml-5 bg-red-500" onClick={handleStart}>
        Start
      </button> */}
      <button
